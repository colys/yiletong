    ...
    <div class="box">
        <div class="login-box">
            <div class="login-title text-center">
                <h1><small>福州易乐通信息有限公司</small></h1>
            </div>
            <div class="login-content ">
                <%if(!string.IsNullOrEmpty( ViewBag.Error)){ %>
                <div style="color:red;position:absolute;top:100px;left:15px;"><%=ViewBag.Error %></div>
                <%} %>
                <div class="form">
                    <form action="DoLogin?backurl=<%=ViewBag.backUrl!=null? ViewBag.backUrl:""%>" method="post">
